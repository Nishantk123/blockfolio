          ...
          <div className="news-container">
            <div className="row news-story">
              ...
              <div className="col-sm-8">
                <div className="signal-title">{data.source}</div>
                <div className="signal-categories">{data.categories}</div>
                <div className="signal-body">{data.body}</div>
              </div>
            </div>
          </div>
        );
      ...
      <div>
        ...
        {/* <div class="news-top-data">
                   <div className="row top-row">
                     <div className="col-sm-8 latest-story">
                        Latest Stories
                     </div>
                     <div className="col-sm-4 source">
                        Sources
                     </div>
                   </div>
                 </div> */}
